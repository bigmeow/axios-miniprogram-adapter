(my["webpackJsonp"] = my["webpackJsonp"] || []).push([["vendor"],{
...
function mpAdapter(config) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    var requestHeaders = config.headers; // miniprogram network request config
...
(function (global, factory) {
  ...
  var warn = noop; // work around flow check
  ...
  function initVMToMP(vm) {
    var obj;
    var sep = LIST_TAIL_SEPS[vm.$mp.platform] || LIST_TAIL_SEPS.wechat;
    vm = vm || this; // const cid = getVMId(vm)

    var vmId = getVMId(vm); // console.log(vmId)
  ...
  function getVnode(vnode, hid) {
    ...
    if (componentInstance) {
      var $slots = componentInstance.$slots;
  ...
  function afterRenderSlot(nodes, name, fallback, props, bindObject) {
    var _fid = props._fid; // single tag:
    ...
    var scopedSlotFn = this.$scopedSlots[name]; // update vnode hid in scoped slot with the slot host's actual fid
  ...
  function updateAttrs(oldVnode, vnode) {
    ...
    var bindingAttrs = (attrs._batrs || '').split(','); // clone observed objects, as the user probably wants to mutate it
  ...
  app$1.init = function (opt) {
    ...
    _App({
      ...
      onLaunch: function onLaunch(options) {
        ...
        if (globalData === void 0) globalData = function globalData() {};
